...
binary_classifier = tfk.models.load_model(
    '/home/simones95/EnvCrime/Local50_PS32_K15.h5',
    custom_objects={'HideLayer':HideLayer,
...
for l in binary_classifier.layers:
    l.trainable = True
...
lr_cb = tf.keras.callbacks.ReduceLROnPlateau(monitor="val_binary_accuracy", mode="max", factor=0.25, patience=15)
# Create an early stopping callback.
es_cb = tf.keras.callbacks.EarlyStopping(monitor="val_binary_accuracy", mode="max", patience=20, restore_best_weights=True)
